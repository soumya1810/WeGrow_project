                    ...
                    <div class='products'>
                      <div class='product' style='border-color: lightgrey; border-width: 0.5px; border-style: solid; '>
                        ...
                        <div class='product-info text-left'>
                          <h3 class='name'><a href='display.php?id=$id'>$shopname</a></h3>
                          
                          <div class='description'></div>
                          
                        <p>   $city,  $state </p>
                       
                          <a href='display.php?id=$id'><button type='button' class='btn btn-info btn-sm ' >View More</button></a>
             ...
             <?php 
              ...
              <div class='products'>
                <div class='product'>
                  ...
                  <div class='product-info text-left'>
                    <h3 class='name' style='margin-bottom: 0px;''><a href='display.php?id=$id'>$shopname</a></h3>
                  ...
                  <div class='Shop clearfix animate-effect'>
                    <div class='action'>
                      <ul class='list-unstyled'>
                        ...
                        <li class='lnk wishlist ' style='margin-top:8%'> <a class='add-to-Shop' href='home.php?liked_shop=$shopname' title='Wishlist'> <i class='icon fa fa-heart'></i> </a> <a href='display.php?id=$id'><button type='button' class='btn btn-info btn-sm 'style='margin-left: 5%;' >View More</button></a> </li>

        ...
        <div class="sidebar pe-4 pb-3" style="color:#74BDCB;">
            <nav class="navbar bg-light navbar-light" style="color:#74BDCB;">
                ...
                <div class="navbar-nav w-100" style="color:#74BDCB;">
                    <a href="#" class="nav-item nav-link active" style="color:#74BDCB;"><i class="fa fa-tachometer-alt me-2" style="color:#74BDCB;"></i>Dashboard</a>
                </div>
                <div class="navbar-nav w-100 mt-3" style="color:#74BDCB;">
                    <a href="home.html" class="nav-item nav-link active" style="color:#74BDCB;"><i class="fa fa-tachometer-alt me-2" style="color:#74BDCB;"></i>All Stores</a>
                </div>
                <div class="navbar-nav w-100 mt-3" style="color:#74BDCB;">
                    <a href="http://localhost/ip_front_copy/display.php?id=9" class="nav-item nav-link active" style="color:#74BDCB;"><i class="fa fa-tachometer-alt me-2" style="color:#74BDCB;"></i>View Site</a>
                </div>
                <div class="navbar-nav w-100 mt-3" style="color:#74BDCB;">
                    <a href="ip_form_update.php?id=9" class="nav-item nav-link active" style="color:#74BDCB;"><i class="fa fa-tachometer-alt me-2" style="color:#74BDCB;"></i>Update Site</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand  sticky-top px-4 py-0"  data-bs-theme="dark" style="background-color:#74BDCB; color:white;">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle text-light" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="imgs/user.jpeg" alt="" style="width: 40px; height: 40px;">
                            <span class="d-none d-lg-inline-flex text-light">Om Electricals</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            <a href="#" class="dropdown-item">My Profile</a>
                            <a href="#" class="dropdown-item">Settings</a>
                            <a href="owner_logout.php" class="dropdown-item">Log Out</a>
                        </div>
                    </div>
                </div>
            </nav>
                    ...
                    <div class="col-sm-12 col-md-6 col-xl-4">
                        <div class="h-100 bg-light rounded p-4">
                            ...
                            <div class="d-flex align-items-center border-bottom py-3">
                                <img class="rounded-circle flex-shrink-0" src="imgs/user.jpg" alt="" style="width: 40px; height: 40px;">
